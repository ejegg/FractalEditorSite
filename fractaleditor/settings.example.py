...
# Change this to host on a public webserver.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'fractals.db3', # Or path to database file if using sqlite3.
...
ROOT_URLCONF = 'fractaleditor.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'fractaleditor.wsgi.application'
